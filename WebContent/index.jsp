...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">RENTIFY</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#Buyer">Buyer</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#Seller">Seller</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To RENTIFY</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">ONE STOP SOLUTION FOR
			RENTAL HOUSE SEARCH!!</p>
		</div>
	</header>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Rentifiy is a one stop place for rental house search.
					everything at one place with detailed description about houses that are according to your requirement!</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">You can search for your desired rental houses
					just by providing the details of house according to your requirement!!</p>
				</div>
			</div>
